...
- (void)mediaGiftPressed:(NSMutableDictionary*)dict;
{
    // 谈起礼物窗体
//    NSMutableDictionary *dict = [NSMutableDictionary dictionary];
//    dict[@"icon"] = @"https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1502773743685&di=40557e5032cd476030dbe5792178fba0&imgtype=0&src=http%3A%2F%2Fimg.zcool.cn%2Fcommunity%2F015f0957bef21c0000018c1bd9fa4c.jpg";
//    dict[@"name"] = @"天使之恋";
//    dict[@"price"] = @"10";
    
    
    
    NIMMessage *message = [NIMMessageMaker msgWithGift:dict];
