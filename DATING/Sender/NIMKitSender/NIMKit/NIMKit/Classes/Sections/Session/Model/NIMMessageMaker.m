...
+ (NIMMessage*)msgWithGift:(NSDictionary*)dict
{
    NTESSendGiftAttachment *attachment = [[NTESSendGiftAttachment alloc] init];

    attachment.messageDic = dict;
