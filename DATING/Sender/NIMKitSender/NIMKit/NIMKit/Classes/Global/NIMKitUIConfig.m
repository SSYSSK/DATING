...
- (NSArray *)defaultMediaItems
{
    ...
    NSString *is_dial_audio = (NSString*)[[NSUserDefaults standardUserDefaults]valueForKey:@"is_dial_audio"];//  系统是否允许语音
    NSString *kis_dial_video = (NSString*)[[NSUserDefaults standardUserDefaults]valueForKey:@"is_dial_video"];// 系统是否允许视频
    NSString *is_rcv_video = (NSString*)[[NSUserDefaults standardUserDefaults]valueForKey:@"is_rcv_video"];// 用户是否允许视频
    NSString *is_rcv_audio = (NSString*)[[NSUserDefaults standardUserDefaults]valueForKey:@"is_rcv_audio"];// 用户是否允许语音
    
    
    
    NSMutableArray *array = [NSMutableArray array];
//    if ([is_dial_audio isEqualToString:@"1"] && [is_rcv_audio isEqualToString:@"1"]){
//        [array addObject:[NIMMediaItem item:@"onTapMediaItemAudioChat:"
...
//                                      title:@"实时语音"]];
//    }
//    if ([kis_dial_video isEqualToString:@"1"] && [is_rcv_video isEqualToString:@"1"]){
//        [array addObject:[NIMMediaItem item:@"onTapMediaItemVideoChat:"
...
//    }
    ...
    [array addObject:[NIMMediaItem item:@"onTapMediaItemVideoChat:"
                          ...
                          selectedImage:[UIImage imageNamed:@"btn_bk_media_video_chat_pressed"]
                                  title:@"视频聊天"]];
    [array addObject:[NIMMediaItem item:@"onTapMediaItemPicture:"
...
//                                  title:@"位置"]];
//    [array addObject:[NIMMediaItem item:@"onTapMediaItemWhiteBoard:"
...
//                                  title:@"白板"]];
//    [array addObject:[NIMMediaItem item:@"onTapMediaItemJanKenPon:"
//                            normalImage:[UIImage imageNamed:@"icon_jankenpon_normal"]
//                          selectedImage:[UIImage imageNamed:@"icon_jankenpon_pressed"]
//                                  title:@"石头剪刀布"]];
    [array addObject:[NIMMediaItem item:@"onTapMediaItemSendGift:"
                            normalImage:[UIImage imageNamed:@"gift_rose"]
                          selectedImage:[UIImage imageNamed:@"gift_rose"]
                                  title:@"送礼物"]];
